...
insert into Items (ItemId, TypeCode, CreatedDateTime, UpdatedDateTime)
values ('b81763dc-4b7e-4af7-ad64-2af50cb74666', 'S', now(), now()), -- 1
       ('9477d81a-f324-4835-bea0-7b256ae37069', 'F', now(), now()), -- 2
       ('22526b6c-0667-4c08-b58c-823b098a94a9', 'F', now(), now()), -- 3
       ('e20e5eed-dc07-463f-b763-3e508d994353', 'I', now(), now()), -- 4
       ('d97be831-2e4d-4e85-9b48-f0aa00705e07', 'P', now(), now()), -- 5
       ('a58e9971-365e-4ba0-94f5-a5ac01a43790', 'D', now(), now()), -- 6
       ('86048604-74cd-492e-b93e-5f347cbead4c', 'S', now(), now()), -- 7
       ('87c8aeda-71aa-46ea-9b94-ea759bebf8ae', 'P', now(), now()), -- 8
       ('e93ae5e0-8e5d-4329-b60a-fcb7f4aab109', 'P', now(), now()), -- 9
       ('f8199f27-303f-47e1-904c-abcd117b321a', 'D', now(), now()), -- 10
       ('5503ff00-21e8-47c4-87d6-803e50d50d3f', 'F', now(), now()), -- 11
       ('31b9dc34-982e-432d-acef-5d526fe25da5', 'P', now(), now()), -- 12
       ('f02b2d8e-cb30-4a1f-b33c-395736cb1c93', 'I', now(), now()), -- 13
       ('d0a74e3d-707c-4447-8d8e-d42f27da207b', 'I', now(), now()), -- 14
       ('08beec18-4593-4a43-b404-739a09fa6633', 'I', now(), now()), -- 15
       ('b9773f6e-12ea-4c9d-8393-06c0a5b8a1c2', 'I', now(), now()), -- 16
       ('bf604923-ea85-41d8-93c6-a37bc0485649', 'I', now(), now()); -- 17

insert into Story (StoryId, StoryDateTime, Header, Content)
...
insert into Files (FileId, Filename, Title, Description)
...
insert into Photos (PhotoId, Filename, Title, Description)
...
insert into People (PersonId, FullName, BirthDate, Description)
...
insert into Documents (DocumentId, Title, Type, Filename, Content)
...
insert into Reference (SourceId, TargetId)
